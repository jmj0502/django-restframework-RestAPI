...
class LoginSerializer(serializers.ModelSerializer):
    ...
    password = serializers.CharField(max_length=58, min_length=3, write_only=True)
    ...
    def validate(self, attrs):
        ...
        if not user.is_active:
            raise AuthenticationFailed('You account, is currently disabled. Please, contact an administrator.')
